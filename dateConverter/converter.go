...
var npMonthData = [100]NepaliMonthData{
	{[12]int8{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}, 365}, // 2000 BS - 1944 AD
...
func checkNepaliDate(year int, month int, day int) bool {
	...
	if day < 1 || day > int(npMonthData[year-2000].monthData[month-1]) {
		return false
	}
	return true
}
...
func NepaliToEnglish(year int, month int, day int) (enYear int, enMonth int, enDay int) {
	...
	var monthDays [12]int8 = enMonths
	if isLeapYear(enYear) {
		monthDays = enLeapMonths
	}
